...
public class ConfirmSWAvailability extends PageObjectSetup<ConfirmSWAvailability> {
	Wait waitClass;
	...
	public ConfirmSWAvailability(WebDriver driver) {
		super(driver);
	...
	public void Run_ConfirmSWAvailability()throws IOException, SQLException, ClassNotFoundException, InterruptedException {

		Buttons.ClickButton("Accept");
		Click(Confirmation);
		Send("Comments for Support Worker Availability", Comments);
